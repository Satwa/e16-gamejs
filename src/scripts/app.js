...
function loadGameOnline() {
    ...
    document.addEventListener("keydown", _handleOnlineKeyboard)
}
...
function loadGameLocally(){
    ...
    game.map.loadMap().then(() => {
        ...
        document.addEventListener("keydown", _handleLocalKeyboard)
...
function _handleLocalKeyboard(e){
    e.preventDefault()
...
function _handleOnlineKeyboard(e){
    e.preventDefault()
